...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, SPI2_NSS_Pin|SPI2_NSS2_Pin|I2C_SW_SCL_Pin|I2C_SW_SDA_Pin
                          |LED3_Pin|LED4_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, LCD_RESET_Pin|LCD_BL_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : SPI1_NSS_Pin LED2_Pin */
  GPIO_InitStruct.Pin = SPI1_NSS_Pin|LED2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : SPI2_NSS_Pin SPI2_NSS2_Pin */
  GPIO_InitStruct.Pin = SPI2_NSS_Pin|SPI2_NSS2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  ...
  /*Configure GPIO pins : LCD_BL_Pin RS485_TXEN_Pin */
  GPIO_InitStruct.Pin = LCD_BL_Pin|RS485_TXEN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : PCF8574T_INT_Pin */
  GPIO_InitStruct.Pin = PCF8574T_INT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(PCF8574T_INT_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : I2C_SW_SCL_Pin I2C_SW_SDA_Pin */
